...
//  - StateConfig: The callback interface of the external system invoked when a gNMI Set RPC is issued
//  - StateSync: The callback interface of the external system invoked when a gNMI Get RPC is issued for data update.
...
//  - schema func: An user-defined Schema() func generated by ygot
//  - modelData: Supported models used for gNMI Capabilities RPC
//  - ChangeNotification: A callback interface invoked when the data in the Model is changed
//  - StateConfig: The callback interface of the external system invoked when a gNMI Set RPC is issued
//  - StateSync: The callback interface of the external system invoked when a gNMI Get RPC is issued for data update.

...
// - cn: ChangeNotification interface invoked upon the data change.
func NewModel(startup []byte, cn ChangeNotification, sc StateConfig) (*Model, error) {
...
// - cn: ChangeNotification interface invoked upon the data change.
func NewCustomModel(schema func() (*ytypes.Schema, error), modelData []*gnmipb.ModelData, startup []byte, cn ChangeNotification, sc StateConfig) (*Model, error) {
	s, err := schema()
	if err != nil {
		return nil, status.Error(codes.Internal, err.Error())
	}

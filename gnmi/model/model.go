...
func NewModel(startup []byte, cn ChangeNotification) (*Model, error) {
...
// - cn: ChangeNotification interface invoked upon the data change.
func NewCustomModel(schema func() (*ytypes.Schema, error), modelData []*gnmipb.ModelData, startup []byte, cn ChangeNotification) (*Model, error) {
	s, err := schema()
	if err != nil {
		return nil, status.Error(codes.Internal, err.Error())
	}
